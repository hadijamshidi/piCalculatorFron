...
function ColorPallet() {
    ...
    $("ul.pattern .color1").click(function () {
        return $("#option-color").attr("href", "/static/css/color/default.css")
    });
    $("ul.pattern .color2").click(function () {
        return $("#option-color").attr("href", "/static/css/color/orange-color.css")
    });
    $("ul.pattern .color3").click(function () {
        return $("#option-color").attr("href", "/static/css/color/blue-color.css")
    });
    $("ul.pattern .color4").click(function () {
        return $("#option-color").attr("href", "/static/css/color/green-color.css")
    });
    $("ul.pattern .color5").click(function () {
        return $("#option-color").attr("href", "/static/css/color/yellow-color.css")
    });
    $("ul.pattern .color6").click(function () {
        return $("#option-color").attr("href", "/static/css/color/pink-color.css")
    });
